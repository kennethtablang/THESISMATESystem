...
namespace THESISMATESystem.Server.Migrations
{
    ...
    [Migration("20260923124852_AddAdminBlockAssignmentsAndChapterPanelReviews")]
    partial class AddAdminBlockAssignmentsAndChapterPanelReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("THESISMATESystem.Server.Models.GroupPanelMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CapstoneGroupId", "PanelistId")
                        .IsUnique();

                    b.ToTable("GroupPanelMembers");
                });
            ...
            modelBuilder.Entity("THESISMATESystem.Server.Models.SectionRosterEntry", b =>
                {
                    ...
                    b.ToTable("SectionRosterEntries");
                });
